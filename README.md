...
After using the Microsoft Common Objects in Context [(MS COCO) dataset](https://cocodataset.org/#home) to train your network, you will test your network on novel images!
